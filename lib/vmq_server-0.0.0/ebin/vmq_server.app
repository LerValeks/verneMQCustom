    ...
    [{description,"VerneMQ MQTT Server"},
     ...
     {modules,
         [vmq_auth,vmq_auth_apikey,vmq_cli_human_writer,vmq_cli_json_writer,
          ...
          vmq_plugin_compat_m5,vmq_proxy_xff,vmq_queue,vmq_queue_sup,
          vmq_queue_sup_sup,vmq_ranch,vmq_ranch_config,vmq_ranch_sup,vmq_reg,
          vmq_reg_mgr,vmq_reg_ordered_trie,vmq_reg_sup,vmq_reg_sync,
          vmq_reg_sync_action,vmq_reg_sync_action_sup,vmq_reg_trie,
          vmq_reg_view,vmq_retain_info,vmq_retain_srv,vmq_schema,vmq_server,
          vmq_server_app,vmq_server_cli,vmq_server_cmd,vmq_server_sup,
          vmq_shared_subscriptions,vmq_ssl,vmq_ssl_psk,vmq_status_http,
          vmq_subscriber,vmq_subscriber_db,vmq_sysmon,vmq_sysmon_handler,
          vmq_systree,vmq_time,vmq_tracer,vmq_tracer_cli,vmq_updo,
          vmq_websocket]}]}.
